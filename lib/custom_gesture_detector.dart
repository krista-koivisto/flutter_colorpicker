...
class CustomGestureDetector extends GestureDetector {
  ...
  /// Minimum number of pixels to move before a pan gesture is recognized.
  /// 
  /// By default, panTolerance is [kPanSlop].
  ...
  Widget build(BuildContext context) {
    ...
    if (onPanDown != null ||
        ...
        onPanEnd != null ||
        onPanCancel != null) {
      gestures[CustomPanGestureRecognizer] =
          GestureRecognizerFactoryWithHandlers<CustomPanGestureRecognizer>(
        () => CustomPanGestureRecognizer(debugOwner: this),
        (CustomPanGestureRecognizer instance) {
          instance
            ..tolerance = panTolerance
            ..onDown = onPanDown
            ..onStart = onPanStart
