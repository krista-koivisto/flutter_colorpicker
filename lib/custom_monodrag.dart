...
abstract class CustomDragGestureRecognizer extends OneSequenceGestureRecognizer {
...
class CustomPanGestureRecognizer extends CustomDragGestureRecognizer {
  /// Create a gesture recognizer for tracking movement on a plane.
  CustomPanGestureRecognizer({this.tolerance = kPanSlop, Object debugOwner})
      : assert(tolerance != null), super(debugOwner: debugOwner);

  @override
  bool isFlingGesture(VelocityEstimate estimate) {
    final double minVelocity = minFlingVelocity ?? kMinFlingVelocity;
    final double minDistance = minFlingDistance ?? tolerance;
  ...
  @override
  bool get _hasSufficientGlobalDistanceToAccept {
    return _globalDistanceMoved.abs() > tolerance;
  }
